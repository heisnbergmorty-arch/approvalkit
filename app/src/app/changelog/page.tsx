...
const entries: Entry[] = [
  {
    ...
    bullets: [
      ...
      "Bulk-approve all pending items on the client review page — one name capture, one click. Massive time-saver when there are 8 logo variants to sign off.",
      "Per-project changelog — chronological timeline of every upload, comment, and approval, ready to share or screenshot.",
      "Mark client comments as resolved (agency-side) so you can track which feedback you've actioned.",
